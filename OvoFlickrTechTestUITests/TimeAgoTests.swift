...
// from https://github.com/zemirco/swift-timeago/blob/master/swift-timeagoTests/swift_timeagoTests.swift
...
class swift_timeagoTests: XCTestCase {
    ...
    func testSecondsAgo() {
        ...
        let result = calendar.dateFromComponents(date)!.timeAgo()
        XCTAssertTrue(result.hasSuffix(" seconds ago"))
    }
